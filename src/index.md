...
Read more about the [Zapp Technology](/technology) in depth here.
...
See more in the [deeper docs about tradeoffs](/compare#tradeoffs).

We also [compare](/compare#how-is-this-different-from) Zapps to several alternative approaches in that doc!
...
Check out the [Variant docs](/variations)!
